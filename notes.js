  ...
  notesObj.forEach(function(element, index) {
    html += `
            <div class="noteCard my-2 mx-2 card" style="width: 18rem;border:2px solid black;background-color:cornflowerblue;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-family:cursive;font-size:25px;color:red;margin-left:55px;font-weight:bold;">${element.title}</h5>
                        <p class="card-text" style="font-family:cursive;"> ${element.text}</p>
